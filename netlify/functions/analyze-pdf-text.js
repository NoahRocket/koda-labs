...
exports.handler = async (event) => {
  ...
  const prompt = `Analyze the following text. Identify up to 5 key concepts and provide a brief (1-2 sentence) explanation for each. Return your answer as a JSON array of objects with \'concept\' and \'explanation\' fields.\n\nText:\n"""${text.substring(0, 8000)}"""`;
